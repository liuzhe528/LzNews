package com.lzstudio.news.view.indicator;
...
public class ViewPagerIndicator extends LinearLayout {
	...
	public ViewPagerIndicator(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.ViewPagerIndicators);
		mTabVisibleCount = a.getInt(R.styleable.ViewPagerIndicators_item_count,
				COUNT_DEFAULT_TAB);
	...
	public void setTabItemTitles(List<String> datas) {
		...
		if (datas != null && datas.size() > 0) {
			...
			for (String colum : mTabTitles) {
				// 添加view
				addView(generateTextView(colum));
			}
			// 设置item的click事件
			setItemClickEvent();
		}
