...
import com.lzstudio.news.adapter.CityAdapter;
import com.lzstudio.news.bean.CityItem;
import com.lzstudio.news.dao.CityData;
import com.lzstudio.news.wedget.city.ContactItemInterface;
import com.lzstudio.news.wedget.city.ContactListViewImpl;
...
public class ChooseCityActivity extends Activity implements OnItemClickListener {
	...
	public void init() {
		...
		mTitle = (TextView) this.findViewById(R.id.common_title);
